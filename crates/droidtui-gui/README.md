...
A [Zed GPUI](https://www.gpui.rs/) desktop frontend for DroidTUI, built on the
shared [`droidtui-core`](../droidtui-core) library.
...
tests; `worker` depends only on `droidtui-core`.
...
requirement of gpui, independent of DroidTUI.)
