//! Main Menu Example
//!
//! This example demonstrates how to create and use the droidkraft main menu system.
...
use droidkraft_tui::adb::{AdbCommand, PackageFilter};
use ratatui::{
...
/// Android green color used throughout droidkraft
...
fn render_help(frame: &mut Frame, area: Rect) {
    let help_text = vec![
        ...
        Line::from(""),
        Line::from("This example demonstrates the droidkraft menu system."),
