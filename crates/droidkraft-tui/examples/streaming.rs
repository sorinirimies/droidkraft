...
//!
//! This example demonstrates the screen streaming capabilities of droidkraft.
...
fn render_title(frame: &mut Frame, area: Rect) {
    let title = Paragraph::new(Line::from(vec![
        ...
        Span::styled("- DroidKraft Example", Style::default().fg(Color::White)),
    ]))
    .block(
        Block::default()
            .borders(Borders::ALL)
...
fn render_help(frame: &mut Frame, area: Rect) {
    let help_text = vec![
        ...
        Line::from(""),
        Line::from("DroidKraft uses scrcpy for screen streaming, which provides:"),
