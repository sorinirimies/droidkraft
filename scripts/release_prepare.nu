...
def main [
    ...
    let notes = [
        ...
        "```"
        ""
        "Or download the pre-built binary from the [releases page](https://github.com/sorinirimies/droidkraft/releases)."
        ""
        "## 🚀 Quick Start"
        ""
        "```bash"
        ...
        "## 📋 Requirements"
        ""
        "- Android SDK platform-tools (`adb`) for full functionality"
